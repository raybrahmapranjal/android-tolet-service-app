...
<body>
 ...
 <div class="col-lg-12">
 <br><br>
 <h1 class="text-warning text-center" > User Registration details </h1>
 <br>
 <form id="form1" name="form1" method="GET" action="user.php">
  <form class="form-inline">   
    <input class="form-control mr-sm-2" name="t1"  id="t1" type="search" placeholder="UserID" value="<?php echo @$_GET['t1'];?>" aria-label="Search">
...
$sql="select * from signup where UserID=$a";
