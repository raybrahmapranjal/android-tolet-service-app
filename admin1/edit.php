...
$Id=$_GET["a"];
$query="select* from owner_property where PropertyID='$Id'";
...
<?php
		$con=mysqli_connect("localhost", "root", "", "tolet");
		$q=mysqli_query($con, "select * from owner_information");
...
<input type="t1" name="t1" id="t1" class="form-control" value="<?php echo"$PropertyID";?>" />
...
<label>OwnerID*</label>
<input type="t2" name="t2" id="t2" class="form-control" value="<?php echo"$OwnerID";?>" />
</div>
...
<label>Rent*</label>
 <div class="input-group">
   <div class="input-group-prepend">
       ...
       <input type="t3" name="t3" id="t3" class="form-control" value="<?php echo"$Rent";?>">
  </div>
  </div>
  </div>
...
<input type="t4" name="t4" id="t4" class="form-control" value="<?php echo"$Localities";?>" />
</div>
<div class="form-group">
